...
def dataGenBeatTime(request):
    ...
    with open('/Users/nourelgarhy/Downloads/Fault Detection App-1/blog/datasetss/allllll.csv') as csv_file:
        ...
        # Open file
    with open('/Users/nourelgarhy/Downloads/Fault Detection App-1/blog/datasetss/allllll.csv') as file_obj:
