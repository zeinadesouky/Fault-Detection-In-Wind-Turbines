...
def LSTMPrediction(test):
    ...
    def generator_bearing():
        ...
        if not anomalies0.empty:
            ...
            csv_data= anomalies0.to_csv(r'/Users/nourelgarhy/Downloads/Fault Detection App-1/LSTM_Anomalies/generatorbearing_anomalies.csv',index=False)
    ...
    def generator_temperature():
        ...
        if not anomalies1.empty:
            ...
            csv_data= anomalies1.to_csv(r'/Users/nourelgarhy/Downloads/Fault Detection App-1/LSTM_Anomalies/generatortemp_anomalies.csv',index=False)
    ...
    def hydraulic_group():
        ...
        if not anomalies2.empty:
            ...
            csv_data= anomalies2.to_csv(r'/Users/nourelgarhy/Downloads/Fault Detection App-1/LSTM_Anomalies/hydraulic_anomalies.csv',index=False)
    ...
    def transformer():
        ...
        if not anomalies3.empty:
            ...
            csv_data= anomalies3.to_csv(r'/Users/nourelgarhy/Downloads/Fault Detection App-1/LSTM_Anomalies/transformer_anomalies.csv',index=False)
    ...
    def gearbox_bearing():
        ...
        if not anomalies4.empty:
            ...
            csv_data= anomalies4.to_csv(r'/Users/nourelgarhy/Downloads/Fault Detection App-1/LSTM_Anomalies/gearboxbearing_anomalies.csv',index=False)
    ...
    def gearbox_oil():
        ...
        if not anomalies5.empty:
            ...
            csv_data= anomalies5.to_csv(r'/Users/nourelgarhy/Downloads/Fault Detection App-1/LSTM_Anomalies/gearboxoil_anomalies.csv',index=False)
