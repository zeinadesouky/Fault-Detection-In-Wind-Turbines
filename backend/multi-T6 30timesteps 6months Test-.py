...
train, test = df.loc[df['Timestamp'] <= '2016-07-01 00:00:00+0000'], df.loc[df['Timestamp'] > '2016-07-01 00:00:00+0000']
...
timestamp=df['Timestamp']
train2, test2 = df.loc[df['Timestamp'] <= '2016-07-01 00:00:00+0000'], df.loc[df['Timestamp'] > '2016-07-01 00:00:00+0000']
...
threshold0=means[0]+13*standarddev[0]
...
threshold1=means[1]+13*standarddev[1]
...
threshold2=means[2]+13*standarddev[2]
...
threshold4=means[4]+15*standarddev[4]
